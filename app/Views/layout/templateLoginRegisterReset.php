        ...
        <div class="w-full px-1 py-2 md:px-3 shadow-lg">
            <div class="mx-6 block md:flex justify-between">
                ...
                <div class="block md:flex my-auto md:my-auto hidden" id="submenu">
                    <div class="text-xs md:text-base font-semibold text-center mx-4 mt-1 md:mt-0 py-1 px-2 hover:bg-gray-100 <?= $Login ?>"> <a href="/login"> Login </a></div>
                    <div class="text-xs md:text-base font-semibold text-center mx-4 mt-1 md:mt-0 py-1 px-2 hover:bg-gray-100 <?= $Register ?>"> <a href="/register"> Register </a></div>
                </div>
            </div>
        </div>
        <!-- navbar -->
